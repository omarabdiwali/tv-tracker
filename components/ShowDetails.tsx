        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 py-5 rounded-xl">
            ...
            <div className="col-span-2 sm:col-span-1 bg-gray-800 p-2 px-3 rounded-lg">
              <div className="text-sm font-semibold text-gray-400 mb-1">{show.nextEpisode ? 'Next Episode' : show.lastEpisode ? 'Last Episode' : 'Status'}</div>
              <div className="text-white flex items-center gap-2">
                <svg className="w-4 h-4 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                {show.nextEpisode ? show.nextEpisode : show.lastEpisode ? show.lastEpisode : show.status ? show.status : 'N/A'}
              </div>
            </div>
          </div>
